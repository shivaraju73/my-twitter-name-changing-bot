...
while True:
    user = api.get_user('shivara04146683')
    api.update_profile(name=f'AMEER|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : AMEER|{follower_count(user)} Followers')
